...
class SMARSI(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.crossover = self.long_sma-self.short_sma
    ...
    def next(self):
        ...
        rsi_filter = ((self.rsi[0]<=self.params.rsi_value)|
                      (self.rsi[0]>=(100-self.params.rsi_value)))

        # GO LONG if ...
        if self.crossover[0]<0 and self.crossover[-1]>=0 and \
            trading_filter and walk_forward_filter and rsi_filter:
